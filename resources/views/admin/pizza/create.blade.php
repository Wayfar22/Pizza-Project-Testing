                    ...
                    <div class="active tab-pane" id="activity">
                      <form class="form-horizontal" method="post" action="{{route('admin#insertPizza')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" placeholder="Add Pizza Name" name="name" value="{{old('name')}}">
                            @if ($errors->has('name'))
                        ...
                        <div class="form-group row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="number" class="form-control" placeholder="Add price" name="price" value="{{old('price')}}">
                              @if ($errors->has('price'))
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="number" class="form-control" placeholder="Add Discount price" name="discount" value="{{old('discount')}}">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="number" class="form-control" placeholder="Add waiting time" name="waitingTime" value="{{old('waitingTime')}}">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" placeholder="Enter description" name="description" style="height: 100px"></textarea>
                        ...
                        <div class="form-group row">
                          <div class="offset-sm-2 col-sm-10 ">
                            <button type="submit" class="btn bg-dark text-white float-end">Add</button>                      </form>
